...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0x7e0FC364cF1599D2c4bd4B4786c91814b2c49831");
  const token = useToken("0xE310a8D057BD78E871336D27E735B483a34BFB7F");
  const vote = useVote("0xd44C5D280EcfA5CDA794434FDB0Be67302D347d0");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vind@s à DevDAO - a DAO dos Devs da madrugada</h1>
...
// Apenas membros da DAO vão ver isso. Renderize todos os membros + quantidade de tokens
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>Página dos membros da DevDAO 🧑‍💻 </h1>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro 🧑‍💻 da DevDAO</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
